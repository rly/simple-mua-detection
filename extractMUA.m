...
pl2FileName = '20170127-all_merged_noWB.pl2';

%% get PL2 file metadata
ENV = getLocalEnv();
processedDataRootDir = [ENV.homeDir '/processed_data/'];
pl2FilePath = sprintf('%s/%s/%s', ENV.dataDirRoot, sessionName, pl2FileName);
...
for i = 1:numel(spkcChannelsToRun)
    channelID = spkcChannelsToRun(i);
